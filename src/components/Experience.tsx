    ...
    <section id="experience" className="relative px-6 py-24 md:px-10 md:py-32">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="relative">
          {/* timeline spine */}
          <div className="absolute left-[7px] top-2 h-full w-px bg-gradient-to-b from-amber via-honey/40 to-transparent md:left-[9px]" />

          <div className="space-y-10">
            {experience.map((job, i) => (
              <Reveal key={job.company} delay={i * 0.05} className="relative pl-10 md:pl-14">
                <span className="absolute left-0 top-1.5 grid h-4 w-4 place-items-center rounded-full bg-amber shadow-glow md:h-5 md:w-5">
                  {job.current && (
                ...
                <div className="glass rounded-2xl p-6">
                  ...
                  <p className="mt-1 flex items-center gap-2 text-sm text-ink-dim">
                    <Briefcase size={14} className="text-honey" /> {job.location}
                  </p>
